"""Queue and task widgets for the inspector TUI."""
...
from .utils import format_dt, si_prefix
...
class TaskDetail(Static):
    ...
    def _detail_content(self) -> str:
        ...
        lines = [
            ...
            f"[b]Enqueued:[/b] {format_dt(result.enqueued_at)}",
            f"[b]Started:[/b] {format_dt(result.started_at)}",
            f"[b]Finished:[/b] {format_dt(result.finished_at)}",
            f"[b]Last attempted:[/b] {format_dt(result.last_attempted_at)}",
